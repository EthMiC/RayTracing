...
function start() {
    createWorld(1, 100, Color(25, 25, 25), Color(30, 50, 100), Color(155, 155, 155), Color(255, 200, 75), Math.PI / 4, 0);
    addObject("Camera", Vector3(0, 0, -30), Vector3(0, 0, 0), 40);
    ...
    //     addObject("Cylinder", Vector3(randX, -5.5, randZ), Vector3(0, 0, 0), Vector3(0.75, 9, 0.75), Color(164, 116, 73), 1, 2, 5);
    ...
    //     addObject("Sphere", Vector3(randX, -1, randZ), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(255, 255, 0), 0.75);
    //     addObject("Sphere", Vector3(randX, 2, randZ), Vector3(0, 0, 0), Vector3(3, 3, 3), Color(255, 255, 0), 0.75);
    // }
    // --------------------------------------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------------------------------------
    // addObject("Cylinder", Vector3(0, 0, 0), Vector3(Math.PI/4, 0, 0), Vector3(10, 10, 10), Color(200, 255, 100), 1, 2, 40);
    // --------------------------------------------------------------------------------------------------
    // addObject("Cube", Vector3(0, 0, 0), Vector3(0, 0, 0), Vector3(10, 10, 10), Color(200, 255, 100), 1);
    // --------------------------------------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------------------------------------
    // addObject("Sphere", Vector3(0, 10010, 0), Vector3(0, 0, 0), Vector3(10000, 5, 5), Color(0, 255, 255), 1);
    // addObject("Sphere", Vector3(0, -10010, 0), Vector3(0, 0, 0), Vector3(10000, 5, 5), Color(155, 155, 155), 1);
    // addObject("Sphere", Vector3(10010, 0, 0), Vector3(0, 0, 0), Vector3(10000, 5, 5), Color(255, 0, 255), 1);
    // addObject("Sphere", Vector3(-10010, 0, 0), Vector3(0, 0, 0), Vector3(10000, 5, 5), Color(255, 255, 0), 1);
    // addObject("Sphere", Vector3(0, 0, 10010), Vector3(0, 0, 0), Vector3(10000, 5, 5), Color(255, 0, 0), 1);
    // --------------------------------------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------------------------------------
    // addObject("Sphere", Vector3(0, -4, 6), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(0, 0, 255), 1);
    // addObject("Sphere", Vector3(-12, -5, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(0, 255, 0), 1);
    // addObject("Sphere", Vector3(12, -5, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(255, 0, 0), 1);
    // addObject("Sphere", Vector3(0, -7, -3), Vector3(0, 0, 0), Vector3(3, 3, 3), Color(255, 255, 0), 1);
    // --------------------------------------------------------------------------------------------------
    // addObject("Sphere", Vector3(0, 0, 0), Vector3(0, 0, 0), Vector3(50, 50, 50), Color(0, 255, 0), 1);
    // addObject("Sphere", Vector3(0, -45, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(255, 0, 0), 1);
    // addObject("Sphere", Vector3(0, 45, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(0, 0, 255), 1);
    // addObject("Sphere", Vector3(-45, 0, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(255, 0, 155), 1);
    // addObject("Sphere", Vector3(45, 0, 0), Vector3(0, 0, 0), Vector3(5, 5, 5), Color(155, 0, 255), 1);
    // --------------------------------------------------------------------------------------------------
